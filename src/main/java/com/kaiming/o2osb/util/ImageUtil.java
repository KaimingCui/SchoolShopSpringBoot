...
public class ImageUtil {
    ...
    public static void main(String[] args) throws IOException {
        Thumbnails.of(new File("/Users/kaimingcui/Desktop/o2osb/orgImage/xiaohuangren.jpg"))
                .size(200,200).watermark(Positions.BOTTOM_RIGHT,
                ImageIO.read(new File(basePath + "/watermark.jpg")),0.25f).outputQuality(0.8f)
        .toFile("/Users/kaimingcui/Desktop/o2osb/orgImage/xiaohuangrennew.jpg");
    }
}
